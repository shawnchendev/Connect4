...
P1Player = gamestate_student.Player_AlphaBeta(0,1500)

# P2Player = gamestate_solution.Player_AlphaBeta(0, 2000)
# P1Player = None
P2Player = gamestate_student.Player_AlphaBeta(2,0)
class Connect4:
    ...
    def __init__(self):
        ...
        self.players = [P1Player, P1Player]
